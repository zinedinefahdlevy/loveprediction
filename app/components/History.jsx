...
export default function HistoryComponent({ dataList, setData, open }) {
  return (
    <div className={`z-20 overflow-y-scroll fixed top-0 left-0 w-full h-screen bg-black bg-opacity-40 flex items-center justify-center ${open ? "opacity-100 visible":"invisible opacity-0"} transition-all duration-300 ease-in-out`}>
